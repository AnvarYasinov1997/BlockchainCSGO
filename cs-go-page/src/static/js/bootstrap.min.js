...
+function (a) {
    ...
    if (!a.fn.tooltip) throw new Error("Popover requires tooltip.js"/*tpa=http://perfectweb.su/assets/bootstrap/js/Popover requires tooltip.js*/);
    ...
    function b(b) {
        return this.each(function () {
            var d = a(this), e = d.data("http://perfectweb.su/assets/bootstrap/js/bs.tab");
            e || d.data("http://perfectweb.su/assets/bootstrap/js/bs.tab", e = new c(this)), "string" == typeof b && e[b]()
        })
    }
    ...
    c.VERSION = "3.3.2", c.TRANSITION_DURATION = 150, c.prototype.show = function () {
        ...
        if (d || (d = b.attr("href"), d = d && d.replace(/.*(?=#[^\s]*$)/, "")), !b.parent("li").hasClass("active")) {
            var e = c.find(".active:last a"),
                f = a.Event("http://perfectweb.su/assets/bootstrap/js/hide.bs.tab", {relatedTarget: b[0]}),
                g = a.Event("http://perfectweb.su/assets/bootstrap/js/show.bs.tab", {relatedTarget: e[0]});
            if (e.trigger(f), b.trigger(g), !g.isDefaultPrevented() && !f.isDefaultPrevented()) {
                var h = a(d);
                this.activate(b.closest("li"), c), this.activate(h, h.parent(), function () {
                    e.trigger({
                        type: "http://perfectweb.su/assets/bootstrap/js/hidden.bs.tab",
                        relatedTarget: b[0]
                    }), b.trigger({type: "http://perfectweb.su/assets/bootstrap/js/shown.bs.tab", relatedTarget: e[0]})
                })
            }
        }
