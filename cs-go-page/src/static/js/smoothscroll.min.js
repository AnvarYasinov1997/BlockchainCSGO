function ssc_init() {
    if (document.body) {
        ...
        if (ssc_root = document.compatMode.indexOf("CSS") >= 0 ? s : e, ssc_activeElement = e, ssc_initdone = !0, top != self) ssc_frame = !0; else if (t > c && (e.offsetHeight <= c || s.offsetHeight <= c) && (ssc_root.style.height = "auto", ssc_root.offsetHeight <= c)) {
    ...
    if (t || (t = 1e3), ssc_directionCheck(s, c), ssc_que.push({
        ...
        var o = function () {
            for (var r = +new Date, n = 0, a = 0, i = 0; i < ssc_que.length; i++) {
                var l = ssc_que[i], _ = r - l.start, u = _ >= ssc_animtime, d = u ? 1 : _ / ssc_animtime;
...
function ssc_wheel(e) {
    ...
    var t = e.wheelDeltaX || 0, o = e.wheelDeltaY || 0;
